...
@Entity
@Table(name = "despesa_operacional", schema = "sc_buffett")
@SequenceGenerator(name = "despesa_operacional_sequence", initialValue = 1, allocationSize = 1, schema = "sc_buffett", sequenceName = "despesa_operacional_sequence")
public class DespesaOperacional implements AbstractEntity {

	private static final long serialVersionUID = -326480571176505626L;
	private Long id;
	private double valor;
	private DemonstrativoResultado demonstrativoResultado;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "despesa_operacional_sequence")
	@Column(name = "id")
	public Long getId() {
		return id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DespesaOperacional other = (DespesaOperacional) obj;
		if (id == null) {
			if (other.id != null)
				return false;
